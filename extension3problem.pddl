...
(:init
    ...
    (= (prioridad p1) 3) (= (prioridad p2) 2) (= (prioridad p3) 3) (= (prioridad p4) 1) (= (prioridad p5) 2)
    ...
    (pendiente suministro1) (pendiente suministro2) (pendiente persona1) (pendiente persona2)
...
(:metric minimize(prioridades-servidas))
)
